...
bs is a simple TUI for backstage to do quick queries and search in backstage without leaving the terminal. It's not meant as a replacement for the Backstage frontend.
